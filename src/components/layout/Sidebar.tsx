    ...
    return (
        <div className="w-full h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto py-8 px-4 space-y-8">
                ...
                {/* Subjects */}
                <div>
                    <button onClick={() => { }} className="w-full flex items-center justify-between px-6 py-2 text-xs font-bold uppercase tracking-widest text-white/40 hover:text-white/60">
