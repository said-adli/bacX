            ...
            <div className={`glass-card relative h-48 overflow-hidden group hover:scale-[1.02] cursor-pointer transition-all duration-300 border border-white/5 ${config.border}`}>
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-between z-10">
                    ...
                    <div>
                        ...
                        {/* Initial details like unit count if available */}
                        {(subject.unitCount !== undefined || subject.lessonCount !== undefined) && (
                            <div className="flex items-center gap-4 text-xs font-medium text-white/40 pt-4 border-t border-white/5 group-hover:border-white/10 transition-colors mt-2">
