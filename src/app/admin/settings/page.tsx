    ...
    return (
        <div className="p-8">
            <GlassCard className="p-12 text-center max-w-2xl mx-auto">
                ...
                <h1 className="text-3xl font-bold text-white mb-2">إعدادات لوحة التحكم</h1>
                <p className="text-white/50">هذه الصفحة قيد التطوير. سيتم إضافة إعدادات النظام قريباً.</p>
            </GlassCard>
        </div>
    );
}
