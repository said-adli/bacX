...
import { VirtualizedSubjectGrid } from "@/components/dashboard/VirtualizedSubjectGrid";
...
export default function DashboardPage() {
    ...
    return (
        <div className="space-y-16 animate-in fade-in zoom-in duration-700 pb-20">
            ...
            {/* 3. CRYSTAL GRID (Subjects) - VIRTUALIZED */}
            <div className="space-y-6">
                ...
                {filteredSubjects.length > 0 ? (
                    <VirtualizedSubjectGrid subjects={filteredSubjects} />
                ) : (
                    <div className="py-12 flex flex-col items-center justify-center text-center opacity-50 space-y-4 rounded-2xl border border-white/5 bg-white/5">
