...
export default function AuthLayout({
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#020617] text-white font-sans relative overflow-hidden selection:bg-blue-500/30">
            ...
            >
                <div className="relative mb-6 p-4 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md shadow-[0_0_40px_-10px_rgba(37,99,235,0.3)] group-hover:shadow-[0_0_60px_-10px_rgba(37,99,235,0.5)] transition-all duration-500">
            ...
            <div className="relative z-10 w-full max-w-md px-4 animate-in fade-in zoom-in duration-500">
                <div className="backdrop-blur-md bg-[#020617]/40 border border-white/10 rounded-3xl shadow-[0_0_50px_-10px_rgba(0,0,0,0.5)] p-8 md:p-10 relative overflow-hidden transform-gpu">
