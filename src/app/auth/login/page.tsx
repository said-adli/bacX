...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center p-4 bg-gray-950 relative overflow-hidden font-tajawal direction-rtl">
            ...
            <div className="w-full max-w-[420px] p-8 md:p-10 relative z-10 bg-gray-900 border border-gray-800 shadow-2xl rounded-3xl">
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div className="mt-6 text-center space-y-4">
                        <Link href="/auth/signup" className="text-sm text-gray-500 hover:text-blue-400 transition-colors inline-block">
                            ليس لديك حساب؟ <span className="font-bold text-blue-500 underline-offset-4 hover:underline">سجل الآن</span>
                        </Link>
                    </div>
                </form>
            </div>
